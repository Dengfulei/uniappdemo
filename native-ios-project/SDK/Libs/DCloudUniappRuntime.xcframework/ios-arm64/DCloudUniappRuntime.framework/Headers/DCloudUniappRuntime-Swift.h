...
- (NSArray<id <UniPage>> * _Nonnull)__$$getSystemDialogPages SWIFT_WARN_UNUSED_RESULT;
/// 获取当前页面样式
...
@protocol UniInputElement <UniElement, JSExport>
...
@protocol UniSliderElement <UniElement, JSExport>
...
@protocol UniTextareaElement <UniElement, JSExport>
@property (nonatomic, copy) NSString * _Nonnull value;
/// <ul>
///   <li>
///     表单的控件名称，作为键值对的一部分与表单(form组件)一同提交
